...
export default function CoursesFinderPage() {
  return (
    <div className="relative w-screen min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="pt-32 pb-16 px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Discover the perfect courses from top platforms like Coursera, Udemy, edX, and YouTube. Our AI matches your
            learning style and goals with the most relevant content.
          </motion.p>
